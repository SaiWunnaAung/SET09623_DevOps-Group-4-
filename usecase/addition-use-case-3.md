# addition Use Case 3 Produce the population of a region.

## CHARACTERISTIC INFORMATION

### Goal in Context

As a client I want to produce a report which display the population of a region.* so that *I can easily find population.*
...
1. Information for the population of a region is requested.
